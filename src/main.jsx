...
const RELEASE_PAGE_URL = "https://github.com/digital-shephard/versus-cypher/releases/tag/v0.1.2";
const SOURCE_URL = "https://github.com/digital-shephard/versus-cypher";

const platformReleases = {
  windows: {
    label: "Windows",
    url: "https://github.com/digital-shephard/versus-cypher/releases/download/v0.1.2/Versus-Cypher-Setup-0.1.2-win-x64.exe",
    trust: "Signed Windows installer / Authenticode verified",
  },
  linux: {
    label: "Linux",
    url: "https://github.com/digital-shephard/versus-cypher/releases/download/v0.1.2/Versus-Cypher-0.1.2-linux-x86_64.AppImage",
