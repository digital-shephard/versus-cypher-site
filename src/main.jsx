...
const platformReleases = {
  windows: {
    label: "Windows",
    url: "https://github.com/digital-shephard/versus-cypher/releases/download/v0.1.9/Versus-Cypher-Setup-0.1.9-win-x64.exe",
    trust: "Signed Windows installer / Authenticode verified",
  },
  linux: {
    label: "Linux",
    url: "https://github.com/digital-shephard/versus-cypher/releases/download/v0.1.9/Versus-Cypher-0.1.9-linux-x86_64.AppImage",
    trust: "Linux AppImage / SHA-256 checksum published",
  },
  macos: {
    label: "macOS",
    url: "https://github.com/digital-shephard/versus-cypher/releases/download/v0.1.9/Versus-Cypher-0.1.9-mac-universal.dmg",
